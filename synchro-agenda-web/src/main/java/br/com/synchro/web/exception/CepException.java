package br.com.synchro.web.exception;
...
public class CepException extends Exception {
	 ...
	 */
	public CepException(String methodName, String message, String stack){
	 ...
	 * @param message mensagem generica da excecao lancada
	 */
	public CepException(String code, String message) {
		this.code = code;
		this.message = message;
	}
	 ...
	 */
	public CepException(String message, Throwable throwable) {
		super(throwable);
		this.message = message;		
	}
	 ...
	 */
	public CepException(String message, Exception exception) {
		super(exception);
		this.message = message;
	}
	 ...
	 * @param code codigo da excecao lancada
	 */
	public CepException(String message, Throwable throwable, String code) {
		super(throwable);
		this.message = message;
		this.code = code;
	}
	 ...
	 * @param code codigo da excecao lancada
	 */
	public CepException(String message, Exception exception, String code) {
		super(exception);
		this.message = message;
		this.code = code;
	}	
	 ...
	 * @param throwable objeto que representa um Throwable
	 */
	public CepException(Throwable throwable) {
		super(throwable);
	 ...
	 * @param exception objeto que representa um Exception
	 */
	public CepException(Exception exception) {
		super(exception);
