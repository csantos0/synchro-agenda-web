...
public class GoogleException extends Exception {
	 ...
	 */
	public GoogleException(String methodName, String message, String stack){
	 ...
	 * @param message mensagem generica da excecao lancada
	 */
	public GoogleException(String code, String message) {
		this.code = code;
		this.message = message;
	}
	 ...
	 * @param code codigo da excecao lancada
	 */
	public GoogleException(String message, Throwable throwable, String code) {
		super(throwable);
		this.message = message;
		this.code = code;
	}
	 ...
	 * @param code codigo da excecao lancada
	 */
	public GoogleException(String message, Exception exception, String code) {
		super(exception);
		this.message = message;
		this.code = code;
	}	
